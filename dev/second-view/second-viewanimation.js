...
cssinject(`//<-inject:../second-view/second-viewanimation.css->`);

Object.defineProperties(secondView.prototype, {
	...
	"close": {
		value: function close(shouldpopstate = true) {
	...
	"open": {
		value: function open(name, clickEvent, color, leftActionButton, previousLeftActionButton, title, previousTitle, rightActionButtons, innerHTML) {
			if(this.opened) return;
	...
	"_onmaintransitionend": {
		value: function _onmaintransitionend(e) {
			try {
	...
	"_closinglab": {
		value: function _closinglab(previouslab, labtype) {
			if(previouslab == null) {
	...
	"_ontitletransitionend": {
		value: function _ontitletransitionend(e) {
	...
	"_switchtitle": {
		value: function _switchtitle(title, previousTitle, reverse) {
			try {
	...
	"_onrippletransitionend": {
		value: function _onrippletransitionend(e) {
	...
	"_handleLab": {
		value: function _handleLab(leftActionButton, previousLeftActionButton) {
			try {
	...
	"_spawnRipple": {
		value: function _spawnRipple(x, y, color) {
...
window.sv._progressiveConstructor();